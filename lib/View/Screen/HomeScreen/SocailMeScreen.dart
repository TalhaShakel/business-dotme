                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Row(
                          children: [
                             Image.asset('assets/likeicons.png',height: 24,width: 24,),
                            Padding(
                              padding: const EdgeInsets.symmetric(horizontal: 8),
                              child: MyText(text: '933'),
                            ),
                             Image.asset('assets/commentsicon.png',height: 24,width: 24,),
                            Padding(
                              padding: const EdgeInsets.symmetric(horizontal: 8),
                              child: MyText(text: '23'),
                            ),
                             Image.asset('assets/bookmarkicon.png',height: 24,width: 24,),
                            Padding(
                              padding: const EdgeInsets.symmetric(horizontal: 8),
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  MyText(text: '12,9K',fontsize: 10,fontweight: FontWeight.w400,fontcolor: Colors.white,),
                ],
              ),
            );
          })),
